define("superman-san/app/hot-news/result_1773d3c", ["san", "tslib", "@searchfe/inject-js"], function(n, o, r) {
    return s = {
        0: function(t, e) {
            t.exports = n
        },
        ...
        108: function(t, e, n) {
            ...
            var o, r = n(1), i = n(0), n = n(5), n = (o = i.Component,
            (0,
            r.__extends)(s, o),
            s.prototype.initData = function() {
                return {
                    ...
                    isShowRefreshBtn: !1,
                    currPage: 0,
                    hotTagsTextMap: ["", "新", "商", "热", "沸", "爆", "荐"],
                    hotTagsClassMap: ["", "c-text-new", "c-text-business", "c-text-hot", "c-text-fei", "c-text-bao", "c-text-rec"]
                }
            }
            ,
            s.prototype.refresh = function() {
                var t = this;
                this.data.set("currPage", this.data.get("currPage") + 1),
                this.data.set("isRotate", !0);
            ...
            s.computed = {
                currList: function() {
                    var t = this.data.get("list")
                      , e = Number(this.data.get("currPage") || 0) % 3;
                    return t.slice(10 * e, 10 * e + 10)
                }
            },
            (0,
            r.__decorate)([n.injectable], s));
            function s(t) {
                t = o.call(this, t) || this;
                return t.trimWhitespace = "all",
                t
            }
            e["default"] = n
        },
        2: function(t, e, n) {
            e = function() {
                "use strict";
                function i(t) {
                    return (i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function i(t) {
                        return typeof t
                    }
                    : function i(t) {
                ...
                t.exports = function(t, e, n) {
                    for (var o = function(t) {
                        var e = [t];
                        "function" == typeof t && (e.push(t.prototype),
                        t.prototype.constructor && e.push(t.prototype.constructor.prototype));
                        return e
                    }(t), r = 0; r < o.length; r++)
                        e && ("string" == typeof e ? o[r].template = e : e instanceof Array ? o[r].aPack = e : o[r].aNode = e),
                        n.length && function(t, e) {
                            for (var n = {}, o = 0; o < e.length; o++)
                                a(n, e[o]);
                            var r = t.initData;
                            t.initData = r ? function() {
    ...
    ,
    i.p = "https://mss0.bdstatic.com/se/cache",
    i(i.s = 242);
    function i(t) {
        if (a[t])
            return a[t].exports;
